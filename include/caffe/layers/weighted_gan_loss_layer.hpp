#ifndef CAFFE_WEIGHTED_GAN_LOSS_LAYER_HPP_
#define CAFFE_WEIGHTED_GAN_LOSS_LAYER_HPP_
...
class WeightedGanLossLayer : public LossLayer<Dtype> {
 public:
  explicit WeightedGanLossLayer(const LayerParameter& param)
  ...
  virtual inline const char* type() const { return "WeightedGanLoss"; }

 protected:
  /// @copydoc WeightedGanLossLayer
  ...
  ///cache for the cross_entropy of each input x, used for the calculation of gradient
  Blob<Dtype> weights_;
  Dtype total_weight_;
...
#endif  // CAFFE_WEIGHTED_GAN_LOSS_LAYER_HPP_
